...
import org.apache.tinkerpop.gremlin.tinkergraph.g2.PipesTranslator;
 ...
 */
public class TinkerGraphPipesTranslatorProvider extends TinkerGraphProvider {
    ...
    public GraphTraversalSource traversal(final Graph graph) {
        if ((Boolean) graph.configuration().getProperty("skipTest"))
            ...
            return g.withStrategies(new TranslationStrategy(g, PipesTranslator.of("g")));
        }
    }
}